The entire code for this project has been organized into following python notebooks.
...
However, in order to run the first notebook, you need free hard-disk space of atleast 50GB to store original raw data files. 
